...
public class ReservationServiceImpl implements ReservationService {
    private static final String GATEWAY_LIB_URL = "http://gateway-service:8080/api/v1/libraries/";
    private static final String GATEWAY_RATING_URL = "http://gateway-service:8080/api/v1/rating";
